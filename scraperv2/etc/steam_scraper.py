...
url_matches = "http://api.steampowered.com/IDOTA2Match_570/GetMatchHistory/v1?key=" + \
    api_key + "&skill=3&min_players=10"
...
for i in tqdm(range(len(data_matches["result"]["matches"]))):
    ...
    url_match = "http://api.steampowered.com/IDOTA2Match_570/GetMatchDetails/v1?key=" + \
        api_key + "&match_id=" + str(match_id)
